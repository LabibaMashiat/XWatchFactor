...
const router = createBrowserRouter([
  { path: "/*", element: <NotFoundPages></NotFoundPages> },
  {
    path: "/",
    element: <Main></Main>,
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://x-watch-factor-server.vercel.app/categories/${params.id}`
          ),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://x-watch-factor-server.vercel.app/paybookings/${params.id}`,
            {
              headers: {
