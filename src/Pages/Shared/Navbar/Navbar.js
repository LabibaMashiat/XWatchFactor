...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <img src={logoImg} alt="LogoImage" className=' w-6 h-8' />
    <Link to='/' className="btn btn-ghost normal-case text-xl"><span className='text-orange-800 font-serif'><i>X</i></span>WatchFactor</Link>
  </div>
